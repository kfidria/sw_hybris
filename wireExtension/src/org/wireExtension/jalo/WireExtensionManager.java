 ...
 */
package org.wireExtension.jalo;
...
import org.wireExtension.constants.WireExtensionConstants;
 ...
 */
public class WireExtensionManager extends GeneratedWireExtensionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WireExtensionManager.class.getName());
	 ...
	 */
	public static WireExtensionManager getInstance()
	{
		return (WireExtensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(WireExtensionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WireExtensionManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WireExtensionManager called.");
		}
	}
